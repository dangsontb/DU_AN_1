                  ...
                  <!-- =================================== LỰA CHỌN ===================================== -->
                    ...
                    <div class="row row-cols-1 row-cols-md-3 g-4 sanpham">
                        ...
                        <!-- <div class="col name">
                          <a href="">
                            <div class="card h-100 item">
                              <img src="views/image/anh1.jpg" class="card-img-top anh" alt="...">
                              <div class="card-body">
                                <h6 class="card-title text-left">NIKE DUNK LOW CACAO WOW</h6>
                                <p class="card-text text-left text-danger fw-semibold gia_ht">1,200,000 VNĐ</p>
                                <div class="gia">
                                  <del>2,000,000VNĐ</del>
                                  <span class="bg-danger text-light rounded-circle giamgia">25%</span>
                                </div>
                                <a href="#" class=" muahang">
                                   <i class="fas fa-cart-plus fa-lg"></i>
                                </a>
